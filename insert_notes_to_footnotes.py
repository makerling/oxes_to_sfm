...
print ()
line1 = u'\\v**\\v 4==ism-illâh**GEN.13.4==istidʿâ**GEN.13.4==mezbah**GEN.13.4'
...
for x in cars:	
	...
	verseupdated = lastverse.replace(x, "==" + x + "==",1)
	verselist.append(verseupdated)
# isolate suffix with regex so at end of script the isolated suffix can be moved back to right place
#https://docs.python.org/3.5/library/re.html
suffixisolate = re.sub('(?<=\S)==(?=\S)', '== @@', verseupdated) #check to make sure this regex is right, is non-space really going to catch everything? seems to, catches string at beginning of line...
...
#print ("finallastfixedverse: ",finallastfixedverse)
